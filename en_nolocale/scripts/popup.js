...
update_text.innerHTML = "Checking for updates...";
update_status.appendChild(update_text);
update_status.setAttribute('class', 'message');
update_status.setAttribute('id', 'updateStatus');
removed_text.innerHTML = "The following extensions have been removed from the Chrome Web Store";
removed_status.setAttribute('title', "These may have been removed due to a violation of the Terms of Service.");
...
checkForUpdates(function (updateCheck, installed_versions, appid, updatever, is_webstore) {
    ...
    if (was_removed) {
        ...
        span.innerHTML = "$extName$ Update Failed";
        appcontainer.appendChild(li);
    ...
    update_text.innerHTML = "All extensions are up to date!";
});
